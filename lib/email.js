...
function newsletterWelcomeHtml(lang = "fr") {
  ...
  const t = isFr ? {
    ...
    sub: "Conseils, tendances et ressources pour créer et monétiser tes micro-dramas verticaux. Sans spam.",
    ...
    sub: "Tips, trends and resources to create and monetize your vertical micro-dramas. No spam.",
