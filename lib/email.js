            ...
            <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
              <tr>
                <td style="vertical-align:middle;">
                  <!-- Logo phone icon (gradient orange→violet) -->
                  <table cellpadding="0" cellspacing="0" style="display:inline-table;margin-right:10px;vertical-align:middle;">
                    <tr>
                      <td style="background:linear-gradient(135deg,${RED},${VIO});border-radius:7px;width:26px;height:37px;text-align:center;vertical-align:middle;font-size:15px;line-height:37px;">
                        📱
                      </td>
                    </tr>
                  </table>
                ...
                <td style="padding-left:10px;vertical-align:middle;">
                  <span style="font-family:Helvetica,Arial,sans-serif;font-size:11px;font-weight:600;color:#64748b;letter-spacing:3px;text-transform:uppercase;display:block;margin-bottom:2px;">Vertical</span>
                  <span style="font-family:Georgia,serif;font-size:20px;font-weight:900;color:#f1f5f9;letter-spacing:-0.5px;">Clap</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="background:#f8f9fb;padding:20px 32px;text-align:center;border-top:1px solid #e8ecf0;">
            <p style="font-size:12px;color:#94a3b8;margin:0 0 6px;">
              © 2026 VerticalClap · <a href="${APP_URL}/confidentialite" style="color:#94a3b8;text-decoration:none;">Confidentialité</a> · <a href="${APP_URL}/cgu" style="color:#94a3b8;text-decoration:none;">CGU</a>
            </p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#faf5ff;border:1px solid #e9d5ff;border-radius:14px;padding:20px;margin-top:24px;">
      <tr><td>
        ...
        <p style="font-size:13px;color:#4c1d95;margin:0 0 12px;line-height:1.6;">
          Jusqu'à <strong>90 épisodes</strong>, <strong>4 variations</strong> par script et <strong>Affiche IA</strong> — pour +10€/mois.
        </p>
...
function newsletterWelcomeHtml() {
  const articles = [
    { cat: "Guide · 7 min", titre: "Qu'est-ce qu'un micro-drama vertical ?", slug: "micro-drama-vertical" },
    { cat: "Écriture · 5 min", titre: "Écrire un hook TikTok irrésistible", slug: "hook-tiktok" },
    { cat: "Distribution · 9 min", titre: "TikTok vs DramaBox vs ReelShort", slug: "tiktok-dramabox-reelshort" },
  ];
  return base("Bienvenue dans la newsletter VerticalClap", `
    <h1 style="font-family:Georgia,serif;font-size:26px;font-weight:900;color:#0f172a;margin:0 0 12px;text-align:center;letter-spacing:-0.5px;line-height:1.3;">
      Bienvenue dans la newsletter<br>VerticalClap 🎬
    </h1>
    <p style="font-size:15px;color:#64748b;line-height:1.7;margin:0 0 32px;text-align:center;">
      Tu recevras les conseils, tendances et ressources pour créer et monétiser tes micro-dramas verticaux. Pas de spam — seulement du contenu utile.
    </p>

    <table width="100%" cellpadding="0" cellspacing="0" style="background:${DARK};border-radius:14px;overflow:hidden;margin-bottom:28px;">
      <tr>
        <td style="padding:18px 20px 6px;">
          <p style="font-size:10px;font-weight:800;letter-spacing:2px;text-transform:uppercase;color:${RED};margin:0 0 14px;">Pour commencer, nos 3 meilleurs articles</p>
        </td>
      </tr>
      ${articles.map((a, i) => `
      <tr>
        <td style="padding:0 20px ${i < articles.length - 1 ? "0" : "16px"};">
          <a href="${APP_URL}/blog/${a.slug}" style="display:block;text-decoration:none;padding:14px 0;border-bottom:${i < articles.length - 1 ? "1px solid rgba(255,255,255,0.07)" : "none"};">
            <p style="font-size:11px;color:#64748b;margin:0 0 4px;">${a.cat} →</p>
            <p style="font-size:15px;font-weight:700;color:#f1f5f9;margin:0;">${a.titre}</p>
          </a>
        </td>
      </tr>`).join("")}
    </table>
    ...
    <p style="font-size:13px;color:#94a3b8;text-align:center;margin:8px 0 0;">
      Bible + scripts d'une série complète en 5 minutes.
    </p>
  `);
}
