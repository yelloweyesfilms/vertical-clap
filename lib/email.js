            ...
            <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
              <tr>
                ...
                <td style="padding-left:10px;vertical-align:middle;">
                  <span style="font-family:Georgia,serif;font-size:20px;font-weight:900;color:#f1f5f9;letter-spacing:-0.5px;">Vertical</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="background:#f8f9fb;padding:20px 32px;text-align:center;border-top:1px solid #e8ecf0;">
            <p style="font-size:12px;color:#94a3b8;margin:0 0 6px;">
              © 2026 Studio Vertical · <a href="${APP_URL}/confidentialite" style="color:#94a3b8;text-decoration:none;">Confidentialité</a> · <a href="${APP_URL}/cgu" style="color:#94a3b8;text-decoration:none;">CGU</a>
            </p>
...
export async function sendNewsletterWelcomeEmail({ email }) {
  ...
  try {
    await resend.emails.send({
      from: FROM,
      to: email,
      subject: "Bienvenue dans la newsletter Studio Vertical 🎬",
...
function winbackHtml() {
  return base("On regrette ton départ", `
    <div style="text-align:center;margin-bottom:24px;">
      ...
      <p style="font-size:15px;color:#64748b;line-height:1.7;margin:0;">
        Tu as résilié ton abonnement Studio Vertical.<br>
...
function newsletterWelcomeHtml() {
  const articles = [
    { title: "Qu'est-ce qu'un micro-drama vertical ?", url: `${APP_URL}/blog/qu-est-ce-qu-un-micro-drama`, label: "Guide · 7 min" },
    { title: "Écrire un hook TikTok irrésistible", url: `${APP_URL}/blog/comment-ecrire-un-hook-tiktok`, label: "Écriture · 5 min" },
    { title: "TikTok vs DramaBox vs ReelShort", url: `${APP_URL}/blog/tiktok-vs-dramabox-vs-reelshort-ou-publier-micro-drama`, label: "Distribution · 9 min" },
  ];
  return base("Bienvenue dans la newsletter", `
    <div style="text-align:center;margin-bottom:28px;">
      <h1 style="font-family:Georgia,serif;font-size:26px;font-weight:900;color:#0f172a;margin:0 0 12px;letter-spacing:-0.5px;line-height:1.3;">
        Bienvenue dans la newsletter<br>Studio Vertical 🎬
      </h1>
      <p style="font-size:15px;color:#64748b;line-height:1.7;margin:0;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background:${DARK};border-radius:14px;padding:22px;margin-bottom:24px;">
      <tr><td>
        <p style="font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:${RED};margin:0 0 14px;">Pour commencer, nos 3 meilleurs articles</p>
        ${articles.map(a => `
          <table cellpadding="0" cellspacing="0" width="100%" style="background:#0f0f1a;border-radius:10px;margin-bottom:8px;">
            <tr>
              <td style="padding:14px 16px;">
                <a href="${a.url}" style="text-decoration:none;">
                  <p style="font-size:14px;font-weight:700;color:#f1f5f9;margin:0 0 4px;">${a.title}</p>
                  <p style="font-size:12px;color:#64748b;margin:0;">${a.label} →</p>
                </a>
              </td>
            </tr>
          </table>`).join("")}
    ...
    <div style="text-align:center;">
      ${btn("Essayer le studio gratuitement →", `${APP_URL}/tarifs`, true)}
    </div>
    <p style="font-size:13px;color:#94a3b8;text-align:center;margin:12px 0 0;">
