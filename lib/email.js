...
function newsletterWelcomeHtml(lang = "fr") {
  ...
  return base(isFr ? "Bienvenue dans la newsletter VerticalClap" : "Welcome to the VerticalClap newsletter", `
    ...
    <div style="margin:-36px -32px 28px;line-height:0;">
      <img src="${APP_URL}/banniere%20hero.png" alt="VerticalClap" width="580" style="width:100%;max-width:580px;display:block;border-radius:0;" />
    </div>
    ...
    <div style="text-align:center;">
      ...
      <img src="${APP_URL}/cliffhangers%20.png" alt="Exemples" width="516" style="width:100%;max-width:516px;display:block;margin:0 auto 20px;border-radius:12px;" />
