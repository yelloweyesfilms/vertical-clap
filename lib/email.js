        ...
        <tr>
          <td style="background:#09090f;padding:24px 32px;text-align:center;border-bottom:1px solid rgba(255,255,255,0.06);">
            <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
              <tr>
                <td style="background:${RED};border-radius:8px;padding:6px 10px;vertical-align:middle;">
                  <span style="color:#fff;font-family:Georgia,serif;font-size:13px;font-weight:900;letter-spacing:1px;">▶</span>
                </td>
                <td style="padding-left:10px;vertical-align:middle;">
                  <span style="font-family:Georgia,serif;font-size:20px;font-weight:900;color:#f1f5f9;letter-spacing:-0.5px;">Vertical</span><span style="font-family:Georgia,serif;font-size:20px;font-weight:900;color:${RED};letter-spacing:-0.5px;">Clap</span>
                </td>
              </tr>
            </table>
          </td>
...
function newsletterWelcomeHtml(lang = "fr") {
  ...
  const articles = isFr ? [
    ...
    { title: "What is a vertical micro-drama?", url: `${APP_URL}/blog/qu-est-ce-qu-un-micro-drama`, label: "Guide", time: "7 min", color: RED, emoji: "🎬" },
    { title: "Writing an irresistible TikTok hook", url: `${APP_URL}/blog/comment-ecrire-un-hook-tiktok`, label: "Writing", time: "5 min", color: VIO, emoji: "⚡" },
    { title: "TikTok vs DramaBox vs ReelShort — where to publish?", url: `${APP_URL}/blog/tiktok-vs-dramabox-vs-reelshort-ou-publier-micro-drama`, label: "Distribution", time: "9 min", color: "#4ade80", emoji: "🌍" },
  ];
  ...
  return base(isFr ? "Bienvenue dans la newsletter VerticalClap" : "Welcome to the VerticalClap newsletter", `
    ...
    <div style="text-align:center;">
      ...
      <p style="font-size:13px;color:#64748b;margin:0 0 20px;">${t.ctaSub}</p>
      ${btn(t.ctaBtn, `${APP_URL}/exemples`, true)}
    </div>
  `, lang);
}
