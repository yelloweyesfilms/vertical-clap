...
const COPY = {
  fr: {
    ...
    heroSubtitleBold: "Du script au tournage — tout généré en 30 sec. Zéro compétence technique. Tu n'as plus qu'à filmer.",
    ...
    standardFeatures: [
      ...
      "Casting IA — fiches personnages",
      "Mode Tournage + Téléprompteur",
      "🎞️ Découpage technique plan par plan",
      "🌍 Traduction en 8 langues",
      "📄 Export PDF avec affiche",
    ],
    premiumFeatures: [
      "Tout Creator + séries jusqu'à 90 épisodes",
      "Direction Artistique avancée",
      "🎲 3 variations de script par épisode",
      "Casting IA — fiches personnages",
      "Mode Tournage + Téléprompteur",
      "🎞️ Découpage technique plan par plan",
      "🌍 Traduction en 8 langues",
    ...
    faqItems: [
      ...
      { q: "Les scripts sont-ils vraiment prêts à tourner ?", r: "Oui. Chaque scène inclut le dialogue, l'indication de jeu d'acteur et la directive de cadrage 9:16. Le Mode Tournage transforme le script en téléprompteur plein écran auto-scroll — tu poses ton téléphone, il défile. Le Découpage technique génère plan par plan toute la mise en scène : type de plan, angle, mouvement caméra, durée." },
      { q: "Mes séries sont-elles sauvegardées ?", r: "Oui — chaque série est sauvegardée localement sur ton appareil. Retrouve-les depuis l'écran d'accueil avec le bouton 'Mes séries'." },
  ...
  en: {
    ...
    heroSubtitleBold: "From script to shoot — everything generated in 30 sec. Zero technical skills needed. Just press record.",
    ...
    faqItems: [
      ...
      { q: "Are the scripts really ready to shoot?", r: "Yes. Each scene includes dialogue, acting direction and 9:16 framing directive. Shoot Mode turns your script into a full-screen auto-scroll teleprompter — set your phone down, it rolls. The Shot List generates a complete scene breakdown shot by shot: shot type, angle, camera movement, duration." },
      { q: "Are my series saved?", r: "Yes — each series is saved locally on your device. Find them from the home screen with the 'My series' button." },
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 36 }}>
                {(lang === "fr" ? [
                  ...
                  { emoji: "📣", text: "Accroches TikTok — légendes virales par épisode" },
                  ...
                  { emoji: "📣", text: "TikTok hooks — viral captions per episode" },
