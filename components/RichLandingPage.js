...
const COPY = {
  fr: {
    studioBadge: "Studio IA · Micro-drama · Web séries",
    heroLine1: "Ta série,",
    heroLine2: "virale,",
    heroLine3: "maintenant.",
    heroTitle: "Des épisodes",
    heroTitleItalic: "qu'on ne peut pas arrêter.",
    ...
    heroSubtitle: "Hooks, scripts et cliffhangers générés par l'IA — pour tes micro-dramas et web séries.",
  ...
  en: {
    studioBadge: "AI Studio · Micro-drama · Web series",
    heroLine1: "Your series,",
    heroLine2: "viral,",
    heroLine3: "now.",
    heroTitle: "Episodes",
    heroTitleItalic: "no one can stop watching.",
    heroSubtitle: "Hooks, scripts and cliffhangers generated by AI — for your micro-dramas and web series.",
      ...
      <div className="sec" style={{ padding: "80px 40px", borderTop: `1px solid ${BORDER}` }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <p style={{ textAlign: "center", fontSize: 11, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", color: VIO, marginBottom: 16, fontFamily: "'Space Grotesk', sans-serif" }}>
            {lang === "fr" ? "Deux moteurs narratifs" : "Two narrative engines"}
          </p>
          <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "clamp(28px, 3.5vw, 48px)", fontWeight: 900, color: TEXT, letterSpacing: -1.5, lineHeight: 1.05, textAlign: "center", marginBottom: 12 }}>
            {lang === "fr" ? "Un seul studio." : "One studio."}<br />
            <span style={{ fontStyle: "italic", color: "rgba(255,255,255,0.38)" }}>
              {lang === "fr" ? "Deux façons de raconter." : "Two ways to tell stories."}
            </span>
          </h2>
          <p style={{ color: MUTED, fontSize: 15, textAlign: "center", maxWidth: 480, margin: "12px auto 52px", lineHeight: 1.7 }}>
            {lang === "fr"
              ? "Selon ton format et ton ambition, VerticalClap adapte son moteur narratif."
              : "Based on your format and ambition, VerticalClap adapts its narrative engine."}
          </p>
            ...
            <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 24, overflow: "hidden", position: "relative" }}>
              ...
              <div style={{ padding: "28px 28px 12px" }}>
                <div style={{ display: "inline-block", padding: "4px 12px", background: `${VIO}15`, border: `1px solid ${VIO}30`, borderRadius: 20, fontSize: 11, fontWeight: 700, color: VIO, marginBottom: 20, letterSpacing: "0.05em" }}>
                  {lang === "fr" ? "WEB SERIES ENGINE" : "WEB SERIES ENGINE"}
                </div>
                <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "clamp(20px, 2.2vw, 28px)", fontWeight: 900, color: TEXT, letterSpacing: -0.8, lineHeight: 1.15, marginBottom: 12 }}>
                  {lang === "fr" ? "Profond. Ambitieux." : "Deep. Ambitious."}<br />
                ...
                <p style={{ fontSize: 14, color: MUTED, lineHeight: 1.7, marginBottom: 24 }}>
                  {lang === "fr"
                    ? "Narration plus profonde, arcs développés, tension psychologique. Pour des séries premium sur DramaBox et ReelShort."
                    : "Deeper narrative, developed arcs, psychological tension. For premium series on DramaBox and ReelShort."}
                </p>
              </div>
              <div style={{ borderTop: `1px solid ${BORDER}`, padding: "18px 28px 24px", display: "flex", flexDirection: "column", gap: 9 }}>
                {(lang === "fr" ? [
