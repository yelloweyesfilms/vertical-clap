...
const COPY = {
  fr: {
    studioBadge: "La plateforme d'écriture pensée pour les micro-dramas.",
    heroLine1: "Ta série,",
    heroLine2: "virale,",
    heroLine3: "maintenant.",
    heroTitle: "Des hooks. Des twists.",
    heroTitleItalic: "Des cliffhangers.",
    ...
    heroSubtitle: "Hooks, scripts et cliffhangers générés par l'IA. Chaque épisode se termine par une scène impossible à ignorer.",
  ...
  en: {
    studioBadge: "The writing platform built for micro-dramas.",
    heroLine1: "Your series,",
    heroLine2: "viral,",
    heroLine3: "now.",
    heroTitle: "Hooks. Twists.",
    heroTitleItalic: "Cliffhangers.",
    heroSubtitle: "Hooks, scripts and cliffhangers generated by AI. Every episode ends with a scene impossible to ignore.",
