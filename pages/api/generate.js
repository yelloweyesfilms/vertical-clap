...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (action === "script") {
      const { ep, bible, mode, duree, prevEps, lang, ambianceVisuelle: scriptAV, budgetInstr, dramaPremium: scriptDramaPremium, isChoix = false, genreFormat, choixContext } = payload;
      const md = mode === "fast"
