      ...
      <div style={{ minHeight: "100vh", background: DARK, color: TEXT, fontFamily: "var(--sans)" }}>
        ...
        <div className="ex-header" style={{ maxWidth: 860, margin: "0 auto", padding: "72px 24px 0", textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: "var(--sans)", fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, lineHeight: 1.05, letterSpacing: -2, marginBottom: 16, color: TEXT, textTransform: "uppercase" }}>
            4 series generated<br /><span style={{ color: RED }}>in 30 seconds.</span>
          </h1>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(232,92,58,0.12)", border: `1px solid rgba(232,92,58,0.35)`, borderRadius: 20, padding: "6px 18px", marginBottom: 20 }}>
            <span style={{ fontSize: 11, fontWeight: 800, letterSpacing: 2, color: RED, textTransform: "uppercase" }}>⚠️ Excerpts — not full scripts</span>
          </div>
