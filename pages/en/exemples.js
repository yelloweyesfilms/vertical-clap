      ...
      <div style={{ minHeight: "100vh", background: DARK, color: TEXT, fontFamily: "var(--sans)" }}>
        ...
        <div className="ex-header" style={{ maxWidth: 860, margin: "0 auto", padding: "72px 24px 0", textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: "var(--sans)", fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, lineHeight: 1.05, letterSpacing: -2, marginBottom: 16, color: TEXT, textTransform: "uppercase" }}>
            4 series excerpts<br /><span style={{ color: RED }}>generated in 30 sec.</span>
          </h1>
        ...
        <div className="ex-screen" style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px 56px" }}>
          <img src="/ecran.webp" alt="VerticalClap interface" style={{ width: "100%", display: "block", borderRadius: 20, boxShadow: `0 0 60px rgba(168,85,247,0.15), 0 32px 80px rgba(0,0,0,0.5)`, border: `1px solid ${BORDER}` }} />
        </div>
        ...
        <div className="ex-content" style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px 100px" }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.03)", border: `1px solid ${BORDER}`, borderRadius: 20, padding: 32, marginBottom: 16, position: "relative", overflow: "hidden" }}>
            ...
            <h2 style={{ fontFamily: "var(--sans)", fontSize: 28, fontWeight: 900, color: TEXT, marginBottom: 12, letterSpacing: -1, lineHeight: 1.1 }}>{ex.bible.title}</h2>
          ...
          <div style={{ background: "rgba(255,255,255,0.02)", border: `1px solid ${BORDER}`, borderRadius: 20, padding: 28, marginBottom: 48 }}>
            <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 16, flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 800, color: RED, background: "rgba(232,92,58,0.12)", border: `1px solid rgba(232,92,58,0.35)`, borderRadius: 6, padding: "3px 10px", letterSpacing: 0.5, textTransform: "uppercase" }}>Excerpt</span>
            </div>
            {/* Disclaimer excerpt */}
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10, background: "rgba(232,92,58,0.07)", border: `1px solid rgba(232,92,58,0.25)`, borderRadius: 12, padding: "12px 16px", marginBottom: 20 }}>
              <span style={{ fontSize: 16, flexShrink: 0 }}>⚠️</span>
              <p style={{ fontSize: 13, color: TEXT, lineHeight: 1.6, margin: 0 }}>
                <strong style={{ color: RED }}>Excerpts only.</strong> <span style={{ color: MUTED }}>A full 1-min script includes a hook, 8 to 12 lines across 4 to 6 scenes, and a cliffhanger. The app generates the complete version in 10 seconds.</span>
              </p>
            </div>
          ...
          <div className="ex-cta" style={{ textAlign: "center", background: "rgba(255,255,255,0.02)", border: `1px solid ${BORDER}`, borderRadius: 24, padding: "48px 32px" }}>
            ...
            <p style={{ fontSize: 12, color: MUTED, marginTop: 20, }}>From €9/month · No commitment · Cancel anytime</p>
          </div>
        </div>
      </div>
    </div>
