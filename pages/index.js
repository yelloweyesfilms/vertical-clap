...
const TESTIMONIALS = [
  { text: "J'ai généré ma première série de 10 épisodes en moins de 5 minutes. Les scripts sont directement tournables, rien à réécrire. J'ai posté l'épisode 1 le soir même.", name: "Marie L.", role: "Créatrice TikTok", stats: "85k abonnés · 2,3M vues", avatar: "ML", color: "#E85C3A" },
  { text: "Le Mode Tournage avec téléprompteur change tout. Mon équipe produit 3 séries par semaine avec 2 personnes. On a soumis à DramaBox après 2 semaines.", name: "Tom K.", role: "Producteur indépendant", stats: "12 séries produites", avatar: "TK", color: "#a855f7" },
  { text: "Les 3 variations par script permettent de choisir le ton parfait. Le Premium Suspense génère des dialogues d'un niveau qu'on n'écrirait pas aussi vite seul.", name: "Yasmine B.", role: "Actrice · Réalisatrice", stats: "Sélectionnée ReelShort", avatar: "YB", color: "#4ade80" },
  { text: "La traduction automatique nous a ouvert le marché espagnol. On poste en FR et ES simultanément, 0 effort supplémentaire. Le ROI est dingue.", name: "Lucas M.", role: "Studio de contenu", stats: "3 marchés · FR / ES / PT", avatar: "LM", color: "#60a5fa" },
];
  ...
  return (
    ...
    <div style={{ minHeight: "100vh", background: DARK, color: TEXT, fontFamily: "'Space Grotesk', system-ui, sans-serif", overflowX: "hidden" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 40px 60px", position: "relative", overflow: "hidden" }} className="hero-pad">
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 900, letterSpacing: -3, marginBottom: 32, color: TEXT, lineHeight: 1 }}>
            <div style={{ fontSize: "clamp(56px, 11vw, 130px)", lineHeight: 0.92 }}>Ta série,</div>
            <div style={{ fontSize: "clamp(56px, 11vw, 130px)", lineHeight: 0.95, background: `linear-gradient(135deg, ${RED} 20%, ${VIO})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", fontStyle: "italic" }}>virale,</div>
            <div style={{ fontSize: "clamp(56px, 11vw, 130px)", lineHeight: 0.95, color: TEXT }}>maintenant.</div>
          </h1>

          <p style={{ fontSize: "clamp(14px, 1.8vw, 17px)", color: MUTED, maxWidth: 420, margin: "0 auto 52px", lineHeight: 1.7, fontWeight: 400 }}>
            Bible, scripts, hooks et cliffhangers générés en 5 minutes — prêts pour TikTok, DramaBox et ReelShort.
          </p>
      ...
      <div className="sec" style={{ padding: "56px 40px", borderBottom: `1px solid ${BORDER}`, textAlign: "center", background: "linear-gradient(135deg, rgba(168,85,247,0.06) 0%, rgba(232,92,58,0.04) 100%)" }}>
        <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "clamp(28px,4vw,48px)", fontWeight: 900, color: TEXT, letterSpacing: -1.5, lineHeight: 1.1, marginBottom: 12 }}>Le format 9:16 fonctionne partout.</h2>
        <p style={{ fontSize: 13, color: MUTED, marginBottom: 40, maxWidth: 520, margin: "12px auto 40px" }}>Le format 9:16 fonctionne partout où ton audience regarde</p>
        ...
        <div className="footer-inner" style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 40px 40px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40, marginBottom: 48 }}>
            ...
            <div>
              ...
              {[{ href: "/tarifs", label: "Tarifs" }, { href: "/exemples", label: "Exemples" }].map(({ href, label }) => (
            ...
            <div>
              ...
              {[{ href: "/cgu", label: "CGU" }, { href: "/confidentialite", label: "Confidentialité" }, { href: "/contact", label: "Contact" }].map(({ href, label }) => (
                <a key={href} href={href} style={{ display: "block", fontSize: 13, color: MUTED, marginBottom: 10, fontWeight: 500 }}>{label}</a>
              ))}
            </div>
          </div>
