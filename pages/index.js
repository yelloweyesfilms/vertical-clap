      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 40px 60px", position: "relative", overflow: "hidden" }} className="hero-pad">
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 900, letterSpacing: -3, marginBottom: 32, color: TEXT, lineHeight: 1 }}>
            ...
            <div style={{ fontSize: "clamp(56px, 11vw, 130px)", lineHeight: 0.95, background: `linear-gradient(135deg, ${RED} 20%, ${VIO})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", fontStyle: "italic" }}>
              virale,
            </div>
            <div style={{ fontSize: "clamp(56px, 11vw, 130px)", lineHeight: 0.95, color: TEXT }}>
              maintenant.
            </div>
          </h1>
